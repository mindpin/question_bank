...
jQuery(document).ready ->
  jQuery(document).on('click','.form-question-single-choice .add-choice',->
    n = jQuery('.form-question-single-choice .question_choice_answer_indexs .radio').length - 1
    dom = jQuery('.form-question-single-choice .question_choice_answer_indexs .radio:first').clone()
    dom.removeClass('hidden')
    dom.find('#question_choices').val("")
    dom.find('input:first').val(n)
    jQuery('.form-question-single-choice .add-choice').before(dom);
  )
  ...
  jQuery(document).on('click','.form-question-single-choice .delete-choice',->
    ...
    m = jQuery('.form-question-single-choice .question_choice_answer_indexs .radio').length
    jQuery('.form-question-single-choice .question_choice_answer_indexs .radio').eq(i).find('input:first').val(i - 2) for i in [a..m]
    jQuery(this).closest('.radio').remove()
  )

  jQuery(document).on('click','.form-question-single-choice .btn-default:last',->
    m = jQuery('.form-question-single-choice .question_choice_answer_indexs .radio').length
    n = jQuery('.form-question-single-choice .question_choice_answer_indexs .radio').length - 1
    dom = jQuery('.form-question-single-choice .question_choice_answer_indexs .radio:first').clone()
    dom.removeClass('hidden')
    dom.find('#question_choices').val("")
    dom.find('input:first').val(n)
    jQuery('.form-question-single-choice .add-choice').before(dom) if (m == 2)
    jQuery('.form-question-single-choice .question_choice_answer_indexs .radio.hidden').remove()
  )
